  ...
  defaultRules = [
    [
      ...
      CS.Class, function(_arg) {
        var args, block, compile, ctor, ctorRef, iife, instance, member, memberName, name, nameAssignee, params, parent, parentExpr, parentRef, protoMember, rewriteThis, _i, _len, _ref3;
        ...
        rewriteThis(block);
        parentExpr = parent != null ? new JS.Identifier(parent.name) : memberAccess(new JS.Identifier('Ember'), 'Object');
      ...
      CS.NewOp, function(_arg) {
        ...
        return new JS.CallExpression(memberAccess(ctor, 'create'), []);
      }
    ], [
